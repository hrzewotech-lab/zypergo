            ...
            <div className="p-8 sm:p-12 bg-white relative font-serif text-slate-900">
              ...
              <div className="mb-10">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  {[
                    { label: 'Aadhaar Card', url: selectedRider.riderDetails?.documents?.aadhaarUrl },
              ...
              <div className="mt-16 flex justify-between items-end">
                 ...
                 {selectedRider.riderDetails?.approvalStatus === 'Pending' && (
                   <button onClick={() => approveRider(selectedRider._id)} className="px-8 py-4 bg-black text-[#FFB703] font-black uppercase tracking-widest text-sm shadow-xl active:scale-95 transition-all flex items-center gap-3 rounded-xl font-sans">
