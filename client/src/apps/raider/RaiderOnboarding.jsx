    ...
    <div className="min-h-screen bg-slate-50 font-sans pb-24">
      <header className="bg-[#0F172A] p-4 flex items-center justify-between shadow-md sticky top-0 z-10">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 bg-[#006D77] rounded flex items-center justify-center text-white">
            <Truck size={16} />
          </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center">
                  ...
                  <input type="tel" name="phone" value={formData.phone} onChange={handleInputChange} required placeholder="10-digit mobile" className="w-full h-11 px-3 border border-slate-300 rounded-r-lg focus:ring-2 focus:ring-[#006D77] outline-none text-sm font-mono" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex items-start">
                  ...
                  <textarea name="address" value={formData.address} onChange={handleInputChange} required placeholder="House No, Street, City, Pincode" className="w-full h-24 p-3 border border-slate-300 rounded-r-lg focus:ring-2 focus:ring-[#006D77] outline-none text-sm resize-none"></textarea>
                </div>
              </div>
            </div>

            <button type="submit" className="w-full bg-[#006D77] text-white font-bold py-3.5 rounded-xl shadow-md hover:bg-[#00585f] flex items-center justify-center gap-2">
          ...
          <form onSubmit={nextStep} className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {['2-Wheeler (Bike)', '3-Wheeler (Auto)', 'Mini Truck', 'Heavy Vehicle'].map(type => (
                    <button 
                      ...
                      className={`p-3 border rounded-xl text-xs font-bold text-left transition ${formData.vehicleType === type ? 'border-[#006D77] bg-[#006D77]/10 text-[#006D77]' : 'border-slate-200 bg-white text-slate-600'}`}
                    >
                      {type}
                    </button>
                  ))}
              ...
              <div>
                ...
                <input type="text" name="regNumber" value={formData.regNumber} onChange={handleInputChange} required placeholder="TS 09 AB 1234" className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-[#006D77] outline-none text-sm uppercase font-bold" />
              </div>

              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-[10px] font-bold text-slate-500 uppercase mb-1">Upload RC Book</label>
                  <div className="border-2 border-dashed border-slate-300 rounded-xl p-4 flex flex-col items-center justify-center text-slate-500 bg-white cursor-pointer hover:border-[#006D77]">
            ...
            <div className="flex gap-3">
              ...
              <button type="submit" className="flex-1 bg-[#006D77] text-white font-bold py-3.5 rounded-xl shadow-md hover:bg-[#00585f] flex items-center justify-center gap-2">
                Next Step <ChevronRight size={18} />
              </button>
            </div>
          </form>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
            ...
            <div className="space-y-4">
              <div className="bg-white p-4 rounded-xl border border-slate-200">
                ...
                <select name="rolePreference" value={formData.rolePreference} onChange={handleInputChange} className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-[#006D77] outline-none text-sm font-bold bg-white">
              ...
              <div className="bg-white p-4 rounded-xl border border-slate-200 space-y-4">
                <div>
                  ...
                  <input type="text" name="accountNumber" value={formData.accountNumber} onChange={handleInputChange} required className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-[#006D77] outline-none text-sm font-mono" />
                </div>
                <div>
                  <label className="block text-xs font-bold text-slate-500 uppercase mb-1">IFSC Code</label>
                  <input type="text" name="ifscCode" value={formData.ifscCode} onChange={handleInputChange} required className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-[#006D77] outline-none text-sm uppercase font-mono" />
                </div>
              </div>
              ...
              <div className="bg-white p-4 rounded-xl border border-slate-200 space-y-4">
                ...
                <div>
                  <div className="flex items-center mb-3">
                    ...
                    <input type="text" name="emergencyName" value={formData.emergencyName} onChange={handleInputChange} required placeholder="Contact Name" className="w-full h-10 px-3 border border-slate-300 rounded-r-lg focus:ring-2 focus:ring-[#006D77] outline-none text-sm" />
                  </div>
                  <div className="flex items-center">
                    ...
                    <input type="tel" name="emergencyPhone" value={formData.emergencyPhone} onChange={handleInputChange} required placeholder="Phone Number" className="w-full h-10 px-3 border border-slate-300 rounded-r-lg focus:ring-2 focus:ring-[#006D77] outline-none text-sm font-mono" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#FFB703]/20 p-4 rounded-xl border border-[#FFB703]/30 mt-4">
              <label className="flex items-start gap-3 cursor-pointer">
                <input type="checkbox" required className="mt-1 w-5 h-5 rounded text-[#006D77] focus:ring-[#006D77]" />
